...
if __name__ == '__main__':
    ...
    epochs = 1000
    n_labels = 2  # 33
    model = VNet_singleTooth(n_channels=2, n_classes=2, normalization='batchnorm', has_dropout=True).to(device)
    ...
    for epoch in range(epochs):
        ...
        for step, (_, vol, seg, ske_map) in enumerate(train_loader):
            ...
            seg_patch1 = model(img_patch1, ske_patch1)
            seg_patch2 = model(img_patch2, ske_patch2)
            seg_patch3 = model(img_patch3, ske_patch3)
